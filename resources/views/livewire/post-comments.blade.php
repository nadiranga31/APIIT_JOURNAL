<div class="mt-10 comments-box border-t border-gray-100 pt-10">
    ...
    <button
        class="mt-3 inline-flex items-center justify-center h-10 px-4 font-medium tracking-wide text-gray transition duration-200 bg-gray-900 rounded-lg hover:bg-gray-800 focus:shadow-outline focus:outline-none">
        Post Comment
    </button>
